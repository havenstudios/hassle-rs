...
use com::{interfaces, AbiTransferable, IID};
...
interfaces! {
    ...
    pub(crate) unsafe interface IDxcDiagnostic: IDxcUnknownShim {
    ...
    pub(crate) unsafe interface IDxcInclusion: IDxcUnknownShim {
    ...
    pub(crate) unsafe interface IDxcToken: IDxcUnknownShim {
    ...
    pub(crate) unsafe interface IDxcType: IDxcUnknownShim {
        pub(crate) unsafe fn get_spelling(&self, result: *mut LPSTR) -> HRESULT;
    ...
    pub(crate) unsafe interface IDxcSourceLocation: IDxcUnknownShim {
    ...
    pub(crate) unsafe interface IDxcSourceRange: IDxcUnknownShim {
    ...
    pub(crate) unsafe interface IDxcCursor: IDxcUnknownShim {
    ...
    pub(crate) unsafe interface IDxcUnsavedFile: IDxcUnknownShim {
    ...
    pub(crate) unsafe interface IDxcFile: IDxcUnknownShim {
    ...
    pub(crate) unsafe interface IDxcTranslationUnit: IDxcUnknownShim {
    ...
    pub(crate) unsafe interface IDxcIndex: IDxcUnknownShim {
    ...
    pub(crate) unsafe interface IDxcIntelliSense: IDxcUnknownShim {
